	...
	return (
		<div className="flex flex-col break-words text-left leading-tight">
			<div className="mb-1 flex flex-wrap items-center gap-1.5">
				<PassiveBadge label={buildLabel} buildType={passive.buildType} />
				<PassiveBadge label={`#${passive.number}`} variant="number" />
			</div>
...
function getPassiveTooltipContent(passive: PassiveRecord) {
	...
	const badgeVisual = getPassiveBuildBadgeVisual(passive.buildType);
