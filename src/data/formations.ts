...
const slot = (id: string, label: PlayerPositionCode, column: number, row: number, offsets?: { top?: number; left?: number }): FormationSlot => ({
	id,
	label,
	column,
	row,
...
const FORMATION_DATA: FormationDefinition[] = [
	{
		...
		slots: [
			slot("player-1", "FW", 1, 1, { top: 5 }), // fw-left
			slot("player-2", "FW", 3, 1), // fw-center
			slot("player-3", "FW", 5, 1, { top: 5 }), // fw-right
			slot("player-4", "MF", 2, 2, { top: -5 }), // mf-left-half
			slot("player-5", "MF", 4, 2, { top: -5 }), // mf-right-half
			slot("player-6", "MF", 3, 3, { top: 6 }), // mf-center
			slot("player-7", "DF", 1, 3), // df-left
			slot("player-8", "DF", 5, 3), // df-right
			slot("player-9", "DF", 2, 5, { top: -5 }), // df-leftmid
			slot("player-10", "DF", 4, 5, { top: -5 }), // df-rightmid
	...
	},
	{
		...
		slots: [
			...
			slot("player-8", "DF", 5, 3, { top: 7 }), // df-right
	...
	},
	{
		...
		slots: [
			slot("player-1", "FW", 3, 1), // fw-center
			slot("player-2", "MF", 2, 2), // mf-left
			slot("player-3", "MF", 4, 2), // mf-right (was player-4)
			slot("player-4", "MF", 3, 3, { left: -10 }), // mf-double-1 (was player-5)
			slot("player-5", "MF", 3, 3, { left: 10 }), // mf-double-2 (was player-6)
			slot("player-6", "DF", 1, 3, { top: 5 }), // df-left (was player-7)
			slot("player-7", "DF", 5, 3, { top: 5 }), // df-right (was player-8)
			slot("player-8", "DF", 2, 4), // df-half-left (was player-9)
			slot("player-9", "DF", 3, 5), // df-center (was player-10)
			slot("player-10", "DF", 4, 4), // df-half-right (was player-9 duplicated)
			slot("player-11", "GK", 3, 6), // gk
		],
	},
	{
		...
		slots: [
			slot("player-1", "FW", 3, 1), // fw-center
			slot("player-2", "MF", 1, 1, { top: 8 }), // mf-left
			slot("player-5", "MF", 5, 1, { top: 8 }), // mf-right
			slot("player-3", "MF", 2, 2, { top: -5 }), // mf-leftmid
			slot("player-4", "MF", 4, 2, { top: -5 }), // mf-rightmid
			slot("player-6", "MF", 3, 3, { left: -15 }), // mf-trail-left
			slot("player-7", "MF", 3, 3, { left: 15 }), // mf-trail-right
			slot("player-8", "DF", 2, 4, { left: -10 }), // df-left
			slot("player-9", "DF", 3, 4, { top: 10 }), // df-center
			slot("player-10", "DF", 4, 4, { left: 10 }), // df-right
			slot("player-11", "GK", 3, 6), // gk
		],
	},
	{
		...
		slots: [
			...
			slot("player-3", "MF", 1, 2, { top: -4 }), // mf-left (was player-4)
			slot("player-4", "MF", 3, 2), // mf-center (was player-3)
			slot("player-5", "MF", 5, 2, { top: -4 }), // mf-right
			slot("player-6", "MF", 2, 3), // mf-half-left
			slot("player-7", "MF", 4, 3), // mf-half-right (was player-6 duplicated)
			slot("player-8", "DF", 2, 5, { left: -10, top: -4 }), // df-half-left (was player-7)
			slot("player-9", "DF", 3, 5), // df-center (was player-8)
			slot("player-10", "DF", 4, 5, { left: 10, top: -4 }), // df-half-right (was player-9)
			slot("player-11", "GK", 3, 6), // gk
		],
	},
	{
	...
	},
	{
		...
		slots: [
			...
			slot("player-2", "MF", 3, 1, { top: 5 }), // mf-cam
			...
			slot("player-7", "DF", 1, 3, { top: 8 }), // df-left
			slot("player-8", "DF", 5, 3, { top: 8 }), // df-right
			slot("player-9", "DF", 2, 5, { top: -5 }), // df-half-left
			slot("player-10", "DF", 4, 5, { top: -5 }), // df-half-right
			slot("player-11", "GK", 3, 6), // gk
		],
	},
	{
		...
		slots: [
			slot("player-1", "FW", 2, 1, { top: 5 }), // fw-half-left
			slot("player-2", "FW", 4, 1, { top: 5 }), // fw-half-right
			slot("player-3", "MF", 1, 2, { top: -5 }), // mf-left (was player-4)
			slot("player-4", "MF", 5, 2, { top: -5 }), // mf-right (was player-5)
			slot("player-5", "MF", 2, 3), // mf-half-left (was player-6)
			slot("player-6", "MF", 4, 3), // mf-half-right (was player-7)
			slot("player-7", "DF", 1, 4, { top: -5 }), // df-left (was player-8)
			slot("player-8", "DF", 5, 4, { top: -5 }), // df-right (was player-9)
			slot("player-9", "DF", 2, 5, { top: -5 }), // df-half-left (was player-10)
			slot("player-10", "DF", 4, 5, { top: -5 }), // Extra slot for 11th player (if required, else use GK as slot-10)
...
export const formationsMap = new Map<string, FormationDefinition>(FORMATIONS.map((formation) => [formation.id, formation]));
